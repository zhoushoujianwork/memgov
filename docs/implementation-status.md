...
| Configurable group execution deadline | Source and focused race checks passed | Both group YAML forms persist a 1–86400-second budget; apply/reapply and real lease-deadline tests pass; local one-hour installation acceptance pending |
