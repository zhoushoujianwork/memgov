...
These checks use temporary homes and synthetic data. They do not send real-platform messages, update an installed binary, or establish real business acceptance. The root/child graph and proactive notification roadmap is unchanged by this storage refactor.
