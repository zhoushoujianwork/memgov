...
- Named group context and independent requester execution passed source, service concurrency and isolated real-Claude checks. Complete local installation acceptance. Explicit cross-member references use available group context; automatic task/process continuation remains separate work.
